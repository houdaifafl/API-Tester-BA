...
export default function MainPanel({ activeTab, responseHeights, requestStates, onMethodChange, onSaveRequest, onExecute, workspaceRole, comments = [], onCommentClick }) {
